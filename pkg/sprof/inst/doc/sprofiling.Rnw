...
%#$HeadURL: svn+ssh://gsawitzki@svn.r-forge.r-project.org/svnroot/sintro/pkg/sprof/vignettes/sprofiling.Rnw $
%#	$Id: sprofiling.Rnw 245 2013-10-14 20:15:24Z gsawitzki $
%#	$Date: 2013-10-14 22:15:24 +0200 (Mon, 14 Oct 2013) $
%#	$Author: gsawitzki $
%#	$Revision: 245 $
...
\indent \emph{Typeset}, with minor revisions: \today\  from SVN $Revision: 245 $ \svnInfoDate}  
...
@
<<fig=TRUE, label=sprofadj04NEL02rlenotit, width=6, height=6, include=FALSE>>=
#6 6
library(Rgraphviz)

plot_graphNEL_sprof(sprof03, nodeattrs="runs", main="", sub="")
@
...
%	cat(chartr("$", " ", "\\verb+$Revision: 245 $+\\\\"))
%	cat(chartr("$", " ", "\\verb+$Date: 2013-10-14 22:15:24 +0200 (Mon, 14 Oct 2013) $+\\\\"))
%	cat(chartr("$", " ", "\\verb+$name:  $+\\\\"))
%	cat(chartr("$", " ", "\\verb+$Author: gsawitzki $+\\\\"))
%	@
\noindent
\verb+$HeadURL: svn+ssh://gsawitzki@svn.r-forge.r-project.org/svnroot/sintro/pkg/sprof/vignettes/sprofiling.Rnw $+\\
\verb+$Source: /u/math/j40/cvsroot/lectures/src/insider/profile/Rnw/profile.Rnw,v $+\\
\verb+$Id: sprofiling.Rnw 245 2013-10-14 20:15:24Z gsawitzki $+\\
\verb+$Revision: 245 $+\\
\verb+$Date: 2013-10-14 22:15:24 +0200 (Mon, 14 Oct 2013) $+\\
\verb+$Name:  $+\\
\verb+$Author: gsawitzki $+
}
\typeout{**** $Id: sprofiling.Rnw 245 2013-10-14 20:15:24Z gsawitzki $ done ****}
\filledpagebreak
