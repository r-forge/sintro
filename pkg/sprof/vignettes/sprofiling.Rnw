...
title(main="nodes run length", sub=sprof04$info$id)
legend("bottomright",legend= c("node color: avg time, pwr=0.5", "node lwd: nr runs, pwr=0.5"), bty="n")
detach(package:Rgraphviz)
@
%edge.lwd<-sprofadj
...
\section{More Graphs}
\label{sec:moregraph}
\emph{Note: This section is collecting experiments  with various graph packages. It is only of interest for you, if you prefer some graphic package and want to look up a wrapper here.}
...
sprofedgel$lwd  <- rkindex(sprofedgel$count, maxindex=12, ties.method="min")
@
\filledpagebreak
...
as_igraph_sprof <- function(sprof, layoutfun, params=NULL,...){
	adj <- adjacency(sprof)
	adj[adj!=0] <-1
	sprofig <- graph.adjacency(adj)
	sprofig <- set.graph.attribute(sprofig, "layout", 
		layoutfun(sprofig,params=params,...),...)
	V(sprofig)$color <- "yellow"
	E(sprofig)$color <- "#0000FF20"
	E(sprofig)$width <- c(1,2)
	return(sprofig)
}
...
V(sprofig)$color <- "yellow"
#E(sprofig)$width <- c(1,2)
E(sprofig)$color <- "#0000FF40"
E(sprofig)$width <- c(1,2)
# see 
<<fig=TRUE, label=sprofigkamada,width=8, height=8>>=
plot(sprofig, main="sprof01: igraph kamada.kawai layout")
<<>>=
sprofig <- graph.adjacency(adjacency(sprof))
sprofig <- set.graph.attribute(sprofig, "layout", layout.auto(sprofig))
@
...
\filledpagebreak
@
<<fig=TRUE, label=sprofig_igraph_auto,width=8, height=8>>=
#8 8
sprofig_auto <- as_igraph_sprof(sprof, layout.auto)
plot(sprofig_auto, main="sprof01: igraph auto layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_random,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.random)
plot(sprofig_auto, main="sprof01: igraph random layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_circle,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.circle)
plot(sprofig_auto, main="sprof01: igraph circle layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_sphere,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.sphere)
plot(sprofig_auto, main="sprof01: igraph sphere layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_fruchterman_reingold,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.fruchterman.reingold)
plot(sprofig_auto, main="sprof01: igraph fruchterman.reingold layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_kamada_kawai,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.kamada.kawai)
plot(sprofig_auto, main="sprof01: igraph kamada.kawai layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_spring,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.spring)
plot(sprofig_auto, main="sprof01: igraph spring layout")
@
%<<fig=TRUE, label=sprofig_igraph_reingold.tilford,width=6, height=6>>=
%#6 6
%sprofig_auto <- as_igraph_sprof(sprof, layout.reingold.tilford)
%plot(sprofig_auto, main="sprof01: igraph reingold.tilford layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_fruchterman_reingold_grid,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.fruchterman.reingold.grid)
plot(sprofig_auto, main="sprof01: igraph fruchterman.reingold.grid layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_lgl,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.lgl)
plot(sprofig_auto, main="sprof01: igraph lgl layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_graphopt,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.graphopt)
plot(sprofig_auto, main="sprof01: igraph graphopt layout")
@
\filledpagebreak

<<fig=TRUE, label=sprofig_igraph_svd,width=6, height=6>>=
#6 6
sprofig_auto <- as_igraph_sprof(sprof, layout.svd)
plot(sprofig_auto, main="sprof01: igraph svd layout")
@
%<<fig=TRUE, label=sprofig_igraph_norm,width=6, height=6>>=
%#6 6
%sprofig_auto <- as_igraph_sprof(sprof, layout.norm)
%plot(sprofig_auto, main="sprof01: igraph norm layout")
...
as_network_sprof <- function(sprof) {
	sprofadj <- adjacency(sprof)
	nwsprofadj <- as.network(sprofadj)
...
plot_network_sprof <- function(nwsprof) {
	...
	if (inherits(nwsprof, "sprof")) nwsprof <- as_network_sprof(nwsprof)
	plot(nwsprof, 
