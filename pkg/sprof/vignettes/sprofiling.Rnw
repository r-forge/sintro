...
<<>>=
plotviz <- function(x,y="dot", main,...)
{
main=paste0(main, "\n plotviz( ",deparse(substitute(x))," )")
plot(x=x,  y=y,
	...
	title(sub=as.character(class(x)))	
	legend("topleft", 
		legend=class(x),
		title="class:"
		)
...
We can add this information to our base.
<<>>=
...
plotviz(as(adjacency(sprof04),"graphNEL"),  
	main="graph layout sprof04", sub=as.character(sprof04$info$id))
par(oldpar)
@
\begin{figure}[htbp]
\begin{center}
...
#legend("bottomright",legend= c("node color: self.time, pwr=0.5", "node #lwd: total.time, pwr=0.5"), bty="n")
	legend("topleft", 
...
legend("bottomright",legend= c("node color: self.time, pwr=0.5", "node lwd: total.time, pwr=0.5"), bty="n", text.font=3)
...
Rgraphviz/graph plot with attributes: see \vref{fig:sprofadj04NEL02}.
...
plotviz(sprofadjNEL02,  main=paste("graph layout\n",sprof$info$id))
@
<<>>=
detach("package:graph")
@
...
plot(sprof_igraph, main="sprof01: igraph kamada.kawai layout")
<<>>=
sprof_igraph <- graph.adjacency(adjacency(sprof))
...
plot(sprof_ig_auto, main="sprof01: igraph auto layout")
	legend("topleft", 
...
#6 6
sprof_ig_auto <- as_igraph_sprof(sprof, layout.random)
plot(sprof_ig_auto, main="sprof01: igraph random layout")
@
\filledpagebreak
...
plot(sprof_ig_auto, main="sprof01: igraph circle layout")
@
\filledpagebreak
...
plot(sprof_ig_auto, main="sprof01: igraph sphere layout")
@
\filledpagebreak
...
plot(sprof_ig_auto, main="sprof01: igraph fruchterman.reingold layout")
@
\filledpagebreak
...
plot(sprof_ig_auto, main="sprof01: igraph kamada.kawai layout")
@
\filledpagebreak
...
plot(sprof_ig_auto, main="sprof01: igraph spring layout")
@
...
plot(sprof_ig_auto, main="sprof01: igraph fruchterman.reingold.grid layout")
@
\filledpagebreak
...
plot(sprof_ig_auto, main="sprof01: igraph lgl layout")
@
\filledpagebreak
...
plot(sprof_ig_auto, main="sprof01: igraph graphopt layout")
@
\filledpagebreak
...
plot(sprof_ig_auto, main="sprof01: igraph svd layout")
@
...
plot_network_sprof <- function(nwsprof,mode = "fruchtermanreingold", ...) {
	...
	main=paste0(main1,": network layout ", mode), 
	mode = mode,
	edge.len=2,
	edge.col="#80808080",
	sub= main1,
...
plot(nwsprofadj, label=rownames(sprofadj02), main="sprof01: network layout", cex.main=2)
@
\filledpagebreak
...
plot(nwsprofadj, label=rownames(sprofadj02), main="sprof01: network layout", cex.main=2, edge.lwd=edge.lwd)
...
# 6 6
plotviz(sprofadjRag02, main="sprof02: Graphviz dot layout")
@
...
#8 8
plot(sprofadjRag02,"neato", main="sprof02: Graphviz neato layout",)
@
\filledpagebreak
<<fig=TRUE, label=sprofadjviztwopi,width=6, height=6>>=
#6 6
plot(sprofadjRag02,"twopi", main="sprof02: Graphviz twopi layout")
@
\filledpagebreak
<<fig=TRUE, label=sprofadjvizcirco8,width=8, height=8>>=
#8 8
plot(sprofadjRag02,"circo", main="sprof02: Graphviz circo layout")
@
\filledpagebreak
<<fig=TRUE, label=sprofadjvizfdp,width=6, height=6>>=
#6  6
plotviz(sprofadjRag02,"fdp", main="sprof01: Graphviz fdp layout",cex=2)
@
\filledpagebreak
...
#6 6
plotviz(sprofadjRag02, main="sprof04: Graphviz dot layout")
@
%agopen(graph, name, nodes, edges, kind = NULL, layout = TRUE,
%layoutType = "dot",
%attrs = list(), nodeAttrs = list(), edgeAttrs = list(),
...
#6
plotviz(x=sprofadjRag02,y="neato", main="sprof04: Graphviz neato layout")
@
\filledpagebreak
<<fig=TRUE, label=s04adjviztwopi,width=6, height=6>>=
#6
plotviz(sprofadjRag02,y="twopi", main="sprof04: Graphviz twopi layout")
@
\filledpagebreak
<<fig=TRUE, label=sprofadjvizcirco6,width=6, height=6>>=
#6
plotviz(sprofadjRag02,y="circo", main="sprof04: Graphviz circo layout 6")
@
\filledpagebreak
<<fig=TRUE, label=s04adjvizfdp,width=6, height=6>>=
#6
plotviz(sprofadjRag02,y="fdp", main="sprof04: Graphviz fdp layout")
@
\section{Template}
\begin{itemize}
	\item{Run a profiling routine to prfoile your functions. You can do it on the fly}
