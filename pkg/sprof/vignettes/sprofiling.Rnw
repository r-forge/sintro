...
%: floating figure
<<fig = TRUE, echo = TRUE, print = FALSE, label=shownodes02, png=TRUE, resolution=100, width=8, height=8, include=FALSE>>= 
#8 8
shownodes(sprof02)
@
...
<<fig = TRUE, echo = TRUE, print = FALSE, label=plotsprof, png=TRUE, resolution=100, width=16, height=12, include=FALSE>>= plot
#12 16
