...
search() 
<<>>=
sprof_igraph <- function(sprof, layoutfun, params=NULL,...){
adj <- adjacency(sprof)
adj[adj!=0] <-1
sprofig <- graph.adjacency(adj)
sprofig <- set.graph.attribute(sprofig, "layout", layoutfun(sprofig,params=params,...),...)
...
#8 8
sprofig_auto <- sprof_igraph(sprof, layout.auto)
...
#6 6
sprofig_auto <- sprof_igraph(sprof, layout.random)
...
#6 6
sprofig_auto <- sprof_igraph(sprof, layout.circle)
...
#6 6
sprofig_auto <- sprof_igraph(sprof, layout.sphere)
...
#6 6
sprofig_auto <- sprof_igraph(sprof, layout.fruchterman.reingold)
...
#6 6
sprofig_auto <- sprof_igraph(sprof, layout.kamada.kawai)
...
#6 6
sprofig_auto <- sprof_igraph(sprof, layout.fruchterman.reingold.grid)
...
#6 6
sprofig_auto <- sprof_igraph(sprof, layout.lgl)
...
#6 6
sprofig_auto <- sprof_igraph(sprof, layout.graphopt)
...
\emph{Note: This section will be replaced by the template section. For intern use only. Skip it.}
